...
export declare function getAvailability(featureName: string): Availability | undefined;
export declare function compareClientVersion(minVer: string, unsupportedFromVer?: string): boolean;
export declare function checkPermissionAndCompareClientVersion(featureName: string, allowExternalBrowser?: boolean, apiNameForDisplay?: string): ReturnIsApiAvailable;
export {};
